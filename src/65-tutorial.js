...
const Tutorial = (() => {
  const STEPS = [
    ...
    { id: 'cross', t: 'Traverse le Voile', h: 'Tuer remplit aussi le Voile violet. Près d\'une fissure (point violet sur la carte) : V, Ctrl ou ◐.' },
    { id: 'crossBack', t: 'Reviens de l\'Envers', h: 'Là-bas, le Voile se vide. Tue des Reflets pour tenir, et reviens par une fissure avant qu\'il soit à zéro.' },
  ];
...
<p>Terrain : l'eau ralentit, le poison et la lave blessent en restant dessus, la glace fait glisser, les gouffres font tomber (retour au dernier sol sûr, un demi-cœur perdu).</p>` },
  voile: { t: 'Voile et Envers', h: `<p>Tuer remplit le <b>Voile</b> (jauge violette). Près d'une <b>fissure</b> (point violet sur la carte, une dans chaque salle de boss), traverser coûte 34 ; ailleurs 70. Il te reste toujours au moins 12 après une traversée.</p>
