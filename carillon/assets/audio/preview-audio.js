...
// ---------------------------------------------------------------- interface
const MANDATORY = new Set(['hit_light', 'hit_heavy', 'hit_crit', 'enemy_die', 'enemy_die_big', 'boss_hit', 'boss_roar', 'player_step', 'player_hurt', 'player_death', 'dash', 'parry_ok', 'parry_miss', 'resonance_1', 'resonance_2', 'resonance_3', 'resonance_4', 'resonance_drop', 'level_up', 'card_flip', 'card_pick', 'xp_pickup', 'xp_pickup_big', 'bell_minute', 'bell_tier', 'silence_cry', 'silence_burst', 'ui_move', 'ui_confirm', 'ui_cancel', 'weapon_battant', 'weapon_clarine', 'weapon_bourdon', 'weapon_grelots', 'weapon_tocsin', 'weapon_cor', 'weapon_crecelle', 'weapon_chaine', 'weapon_diapason', 'fusion', 'achievement', 'lore_unlock', 'victory_bell']);
